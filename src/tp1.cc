...
int main1() {
    ...
    std::shared_ptr<Texture_Material> texture = std::make_shared<Uniform_Texture>(colors_t1, 0.7, 0.1, 2);
    ...
    std::shared_ptr<Texture_Material> texture2 = std::make_shared<Uniform_Texture>(colors_t2, 0.7, 0.1, 20);
    ...
    std::shared_ptr<Texture_Material> texture4 = std::make_shared<Uniform_Texture>(colors_t4, 0.7, 0.1,20);
